...
$exitCode = Invoke-GuestBash -VBoxManage $vboxManage -VmName $VmName -GuestUser $GuestUser -GuestPassword $GuestPassword -Command $Script -TimeoutMs $TimeoutMs -AllowFailure:$AllowFailure -WaitStdout:$WaitStdout -WaitStderr:$WaitStderr
